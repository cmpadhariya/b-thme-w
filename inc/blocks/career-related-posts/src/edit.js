...
export default function Edit(props) {
  ...
  return (
    <>
      <div className="cs-related-post section-padding">
        <div className="container p-0">
          <div className="cs-related-post__inner">
            <div class="cs-related-post__inner_hading">
              <RichText
                tagName="h2"
                value={props.attributes.Heading}
                onChange={onChangeHeading}
                placeholder={__("Similar Openings...")}
              />
            </div>
            <div className={`row`}>
              {posts &&
                posts.map((post) => {
                  return (
                    <div key={post.id} className="col-lg-4 col-md-4 col-12">
                      <div class="cs-related-post__inner_content">
                        <h3>
                          {post.title.rendered ? (
                        ...
                        <h5 className="wp-block-author-box-author-plugin__post-title">
                          <a href={post.link} className="button-view-post">
                            <RichText
