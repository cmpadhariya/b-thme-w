...
/**
 * Register block pattern for case-studies-archive section to display all case study post list.
 */
register_block_pattern(
	'qrolic/case-studies-archive-pattern',
	array(
		'title'       => __( 'Case-studies Archive', 'qrolic' ),
		'description' => _x( 'This pattern include case-studies-archive section to display all case study post list', 'qrolic' ),
        ...
        <!-- wp:group {"className":"case-studies-list__btn","layout":{"type":"default"}} -->
        <div class="wp-block-group case-studies-list__btn"><!-- wp:paragraph -->
        <p><a href="http://localhost/Qrolic-Technologies/case-studies/" data-type="URL" data-id="http://localhost/Qrolic-Technologies/case-studies/"></a></p>
        <!-- /wp:paragraph --></div>
        <!-- /wp:group --></div>
        <!-- /wp:group --></div>
        <!-- /wp:group -->',
